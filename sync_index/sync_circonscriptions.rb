...
if not res.num_tuples.zero? then
	...
	res.each do |r|
        ...
        if old!=new then
            old=new
            puts "Saving departement circo #{circo} from dept #{dept}"
        end
	end
